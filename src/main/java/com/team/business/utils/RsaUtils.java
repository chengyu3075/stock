...
public class RsaUtils {
     ...
     * @throws Exception  
     */  
    private static String publicEncrypt(String encodString) throws Exception{ 
    	String result = null;
    	if(StringUtils.isEmpty(encodString)){
    		return result;
    	}
